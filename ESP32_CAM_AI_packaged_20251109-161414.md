...
- **Generated**: 2025-11-09 16:14:14 +0000
...
**Size**: 8336 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: 3738cc17a36a7e7a9a84ddeed90b7ef5a98f2acb42c1f2a836c9adbb43299cae
``````python
"""
...
**Size**: 11480 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: c3e016753c12b9a76bd3385d1749a20af9abe245b310604ba1ff6795f3fa3b1b
``````python# detectors.py
...
class DetectorThread(QtCore.QThread):
    ...
    def run(self):
        ...
        while not self._stop.is_set():
            ...
            self.resultsReady.emit(pkt)## `discovery_dialog.py`
...
**Size**: 4586 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: 8cf3a72faf91ffb78d9f76e7ed5cce3776633460eafa29d1c2f1357ec7383d68
``````python# gallery.py
...
**Size**: 13313 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: fcf2ae0fc5deba0c094097268531807c61a1cb8f06eedb33623a3eabee26062a
``````python# mdi_app.py
...
**Size**: 2927 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: 736c8693eece67634f6f976f2c89ce8255312c32ce11336cac2d75f21f3ba738
``````python# overlays.py
...
**Size**: 21 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: 7d552a3f7e559055332542c8e7bf0e2e8c0515a50e568f9f19d8f4068eecbfcd
...
**Size**: 11 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: f6f4e34751b81fa0b10213c4feac89861adf8a26a4b72db45dc5cef596876f5a
``````python# package
## `refactor/ai_viewer/ai/detectors/__init__.py`
...
**Size**: 39 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: 6425bc3ec224aff57eda5b48f81d281c16061105744e578f7e29873d071c3b58
``````python# package
...
**Size**: 2829 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: a4c40ec100b1cf30197b82d7c4f6b41aa43fa18c75e495a4d0c4b94443e09822
``````python#!/usr/bin/env python3
"""
...
**Size**: 43 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: d19505a140a9b3a39af14d27f8885ea99dbdc696e35e5482cac0cf20f1c0d070
``````python# package
...
**Size**: 2082 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: af9d1927056fc8ec13add3fc4271d2bfbf2b0028bd9cf15a0b34debcbfd2baa2
``````python#!/usr/bin/env python3
"""
ESP32-CAM MDI Viewer (Qt)
...
**Size**: 1751 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: 573542b2b2f10d4c084732b44a70521400a37ba7975e4e716493130ded529459
``````python#!/usr/bin/env python3
"""
ESP32-CAM MDI Viewer (Qt)
...
**Size**: 78 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: 6880a0b9208b26e15a5cff39b8f17de0ef19d12d6fa3427aa97a469ee8ac6820
``````python# package
...
**Size**: 1470 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: 53a8bf1b7f2b464cb60ecf6715f713614d75dc591d9d8615391517ac00177393
``````python#!/usr/bin/env python3
"""
ESP32-CAM MDI Viewer (Qt)
...
**Size**: 1375 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: c44a33246baad19811bd5c81e28011f531070213b9aae881f02a51c9f9276ce2
``````python#!/usr/bin/env python3
"""
ESP32-CAM MDI Viewer (Qt)
...
**Size**: 1564 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: ee8da98464cd37be33914c14f711b9e76304fa224dbdcb88bcfbb3bc5e1652c1
``````python#!/usr/bin/env python3
"""
ESP32-CAM MDI Viewer (Qt)
...
**Size**: 3586 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: c2874210d90f643f8b746c0d66c5045be339633bf66c4dddda6ee29e62988243
...
**Size**: 2625 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: 6c1f9df07b93223587012b6c6892f8f5f02e33f4f22cb3cc2543d1d2d4bc7e77
...
**Size**: 143 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: cc30af308e5ffdd82c848998845c6075bbd7b6d90a24ea345a938d38f9c64db6
``````python# package
...
**Size**: 3192 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: 0454572bd10be80cff2d762e0874f1e08fbb45aac5e1e0310a491ce35c9b30c3
``````python#!/usr/bin/env python3
"""
ESP32-CAM MDI Viewer (Qt)
...
**Size**: 7310 bytes
**Modified**: 2025-11-09 15:48:14 +0000
**SHA256**: d73dfe9982a77c0e7748df5926b53757962e7d36423fa7a59bf736b17d12fa60
``````python#!/usr/bin/env python3
"""
ESP32-CAM MDI Viewer (Qt)
