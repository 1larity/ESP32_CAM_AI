## Prompt for Copilot
```
I want the cmera viewer to be able to send PTZ commands to individual cameras to track recognised living entities. Some of the entities will move fast, Include plan ahead functionality and object identification to predict the entity's movement.
```
# Packaged Project (Python)
- **Project root**: C:\Users\stellaris\Documents\PlatformIO\Projects\ESP32_CAM_AI\AI
- **Generated**: 2025-10-25 13:11:51 +0100
