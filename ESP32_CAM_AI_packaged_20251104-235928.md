## Prompt for Copilot
```
This MDI camera app needs breaking down into seperate files, it's unmanagably huge, impossible to maintain. Do a functional decomposition, especially on mdi_app, with some clear seperation of responsibility of different related functions to thier respective files.
```
# Packaged Project (Python)
- **Project root**: C:\Users\stellaris\Documents\PlatformIO\Projects\ESP32_CAM_AI\AI
- **Generated**: 2025-11-04 23:59:28 +0000
